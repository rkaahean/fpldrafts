...
function parseBoostrapData(data) {
    var _this = this;
    var elements = data["elements"];
    // get id, team, team_code, web_name, element_type
    var players = elements.map(function (player) {
        return {
            id: player.id,
    ...
    players.forEach(function (player) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, prisma.fPLPlayer.create({
                            data: {
                                player_id: player.id,
                                web_name: player.web_name,
